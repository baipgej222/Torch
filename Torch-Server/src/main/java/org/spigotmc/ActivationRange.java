...
public class ActivationRange
{
    ...
    {
        // quick checks.
        if ( entity.inWater || entity.fireTicks.get() > 0 ) // Torch
        {
            return true;
        }
    ...
    public static boolean checkIfActive(Entity entity)
    {
        ...
        // PAIL: inChunk
        if ( !entity.aa.get() || entity instanceof EntityFireworks ) { // Torch
            return true;
        }
        ...
        int x = MathHelper.floor( entity.locXAtom );
        int z = MathHelper.floor( entity.locZAtom );

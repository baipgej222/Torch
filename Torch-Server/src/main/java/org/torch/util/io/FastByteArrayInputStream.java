...
public class FastByteArrayInputStream extends MeasurableInputStream implements RepositionableStream {
	 ...
	 *            the backing array.
	 * @param offset
	 *            the first valid entry of the array.
	 * @param length
	 ...
	 * {@link java.io.ByteArrayInputStream#read(byte[], int, int)} will return
	 * -1 on a zero-length read at EOF, contrarily to the specification. We
	 * won't.
	 */

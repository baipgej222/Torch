...
public class FastBufferedOutputStream extends MeasurableOutputStream implements RepositionableStream {
	...
	/**
	 * The number of buffer bytes available starting from {@link #pos} (it must
	 * be always equal to <code>buffer.length - pos</code>).
	 */
	protected int avail;
	 ...
	 *             if the underlying output stream is not

...
public class Arrays {
	 ...
	 * 
	 * @param from
	 *            the index of the first element (inclusive) to be included in
	 *            the binary search.
	 * @param to
	 *            the index of the last element (exclusive) to be included in
	 *            the binary search.
	 * @param pos
	 *            the position of the element to be searched for.
	 * @param comp
	 ...
	 * running time is <i>O</i>(<var>n</var>&nbsp;(log&nbsp;<var>n</var>)
	 * <sup>2</sup>), but it does not allocate additional memory; as a result,
	 * it can be used as a generic sorting algorithm.
	 * 
	 * @param from
	...
	/**
	 * Sorts the specified range of elements using the specified swapper and
	 * according to the order induced by the specified comparator using a
	 * parallel quicksort.
	 * 
	 * <p>

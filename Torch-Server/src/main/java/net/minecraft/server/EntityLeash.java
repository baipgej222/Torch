...
public class EntityLeash extends EntityHanging {
    ...
    public EntityLeash(World world, BlockPosition blockposition) {
        ...
        this.a(new AxisAlignedBB(this.locXAtom.get() - 0.1875D, this.locYAtom.get() - 0.25D + 0.125D, this.locZAtom.get() - 0.1875D, this.locXAtom.get() + 0.1875D, this.locYAtom.get() + 0.25D + 0.125D, this.locZAtom.get() + 0.1875D));
    }
    ...
    protected void updateBoundingBox() {
        this.locXAtom.set((double) this.blockPosition.getX() + 0.5D);
        this.locYAtom.set((double) this.blockPosition.getY() + 0.5D);
        this.locZAtom.set((double) this.blockPosition.getZ() + 0.5D);
    }
    ...
    public boolean a(EntityHuman entityhuman, @Nullable ItemStack itemstack, EnumHand enumhand) {
        if (this.world.isClientSide) {
            ...
            if (itemstack != null && itemstack.getItem() == Items.LEAD) {
                d0 = 7.0D;
                list = this.world.a(EntityInsentient.class, new AxisAlignedBB(this.locXAtom.get() - d0, this.locYAtom.get() - d0, this.locZAtom.get() - d0, this.locXAtom.get() + d0, this.locYAtom.get() + d0, this.locZAtom.get() + d0));

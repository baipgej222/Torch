...
public class DragonControllerLandingFly extends AbstractDragonController {
    ...
    public void c() {
        double d0 = this.c == null ? 0.0D : this.c.c(this.a.locXAtom.get(), this.a.locYAtom.get(), this.a.locZAtom.get());
    ...
    private void j() {
        if (this.b == null || this.b.b()) {
            ...
            if (entityhuman != null) {
                Vec3D vec3d = (new Vec3D(entityhuman.locXAtom, 0.0D, entityhuman.locZAtom)).a();

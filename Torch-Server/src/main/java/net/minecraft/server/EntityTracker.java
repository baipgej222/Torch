...
public class EntityTracker {
    ...
    private Set<EntityTrackerEntry> c = Sets.newConcurrentHashSet(); // Torch
    ...
    public void addEntity(Entity entity, int i, final int j, boolean flag) {
        ...
        try {
            if (this.trackedEntities.b(entity.getId())) {
                return; // throw new IllegalStateException("Entity is already tracked!");
            }
    ...
    public void updatePlayers() {
        ...
        arraylist.parallelStream().forEach(entityplayer -> {
            this.c.parallelStream().forEach(entitytrackerentry1 -> {
            	if (entitytrackerentry1.b() != entityplayer) {
                    entitytrackerentry1.updatePlayer((EntityPlayer) entityplayer);
                }
            });
        });
    ...
    public void a(EntityPlayer entityplayer, Chunk chunk) {
        ...
        while (iterator.hasNext()) {
            ...
            if (entity != entityplayer && entity.ab.get() == chunk.locX && entity.ad.get() == chunk.locZ) {
                entitytrackerentry.updatePlayer(entityplayer);

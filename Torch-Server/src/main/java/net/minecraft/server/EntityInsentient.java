...
public abstract class EntityInsentient extends EntityLiving {
    ...
    public void doSpawnEffect() {
        if (this.world.isClientSide) {
            for (int i = 0; i < 20; ++i) {
                ...
                this.world.addParticle(EnumParticle.EXPLOSION_NORMAL, this.locXAtom.get() + (double) (this.random.nextFloat() * this.width * 2.0F) - (double) this.width - d0 * d3, this.locYAtom.get() + (double) (this.random.nextFloat() * this.length) - d1 * d3, this.locZAtom.get() + (double) (this.random.nextFloat() * this.width * 2.0F) - (double) this.width - d2 * d3, d0, d1, d2, new int[0]);
            }
        } else {
    ...
    protected void L() {
        if (this.persistent) {
            ...
            if (entityhuman != null) {
                double d0 = entityhuman.locXAtom.get() - this.locXAtom.get();
                double d1 = entityhuman.locYAtom.get() - this.locYAtom.get();
                double d2 = entityhuman.locZAtom.get() - this.locZAtom.get();
    ...
    public void a(Entity entity, float f, float f1) {
        ...
        if (entity instanceof EntityLiving) {
            ...
            d2 = entityliving.locYAtom.get() + (double) entityliving.getHeadHeight() - (this.locYAtom.get() + (double) this.getHeadHeight());
        } else {
            d2 = (entity.getBoundingBox().b + entity.getBoundingBox().e) / 2.0D - (this.locYAtom.get() + (double) this.getHeadHeight());
        }

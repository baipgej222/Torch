...
public class EntitySkeleton extends EntityMonster implements IRangedEntity {
    ...
    public void die(DamageSource damagesource) {
        ...
        if (damagesource.i() instanceof EntityArrow && damagesource.getEntity() instanceof EntityHuman) {
            ...
            double d1 = entityhuman.locZAtom.get() - this.locZAtom.get();
    ...
    public void a(EntityLiving entityliving, float f) {
        ...
        double d1 = entityliving.getBoundingBox().b + (double) (entityliving.length / 3.0F) - entitytippedarrow.locYAtom.get();
        double d2 = entityliving.locZAtom.get() - this.locZAtom.get();

    ...
    public void l() {
        if (!this.n()) {
            ...
            if (this.f != null) {
                ...
                if (this.a.d(this.f) >= d0 && (this.a.locYAtom.get() <= (double) this.f.getY() || this.a.d(new BlockPosition(this.f.getX(), MathHelper.floor(this.a.locYAtom.get()), this.f.getZ())) >= d0)) {

        ...
        if (this.ah()) {
            ...
            if (this.bH > 0.4F) {
                ...
                for (int j = 0; j < i; ++j) {
                    ...
                    this.world.addParticle(EnumParticle.WATER_SPLASH, this.locXAtom.get() + (double) f1, (double) (f + 0.8F), this.locZAtom.get() + (double) f2, this.motXAtom.get(), this.motYAtom.get(), this.motZAtom.get(), new int[0]);
                }
            }
        }

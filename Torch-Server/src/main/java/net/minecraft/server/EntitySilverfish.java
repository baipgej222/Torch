        ...
        public boolean a() {
            if (!this.silverfish.world.getGameRules().getBoolean("mobGriefing")) {
                ...
                if (random.nextInt(10) == 0) {
                    ...
                    BlockPosition blockposition = (new BlockPosition(this.silverfish.locXAtom.get(), this.silverfish.locYAtom.get() + 0.5D, this.silverfish.locZAtom.get())).shift(this.b);

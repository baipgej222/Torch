        ...
        if (movingobjectposition != null && movingobjectposition.type == MovingObjectPosition.EnumMovingObjectType.BLOCK && world.getType(movingobjectposition.a()).getBlock() == Blocks.END_PORTAL_FRAME) {
            ...
            if (!world.isClientSide) {
                ...
                if (blockposition != null) {
                    EntityEnderSignal entityendersignal = new EntityEnderSignal(world, entityhuman.locXAtom.get(), entityhuman.locYAtom.get() + (double) (entityhuman.length / 2.0F), entityhuman.locZAtom.get());

                    entityendersignal.a(blockposition);
                    world.addEntity(entityendersignal);
                    world.a((EntityHuman) null, entityhuman.locXAtom.get(), entityhuman.locYAtom.get(), entityhuman.locZAtom.get(), SoundEffects.aU, SoundCategory.NEUTRAL, 0.5F, 0.4F / (ItemEnderEye.j.nextFloat() * 0.4F + 0.8F));

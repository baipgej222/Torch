...
public class PathfinderGoalNearestAttackableTarget<T extends EntityLiving> extends PathfinderGoalTarget {
    ...
    public boolean a() {
        if (this.i > 0 && this.e.getRandom().nextInt(this.i) != 0) {
            ...
            this.d = (T) this.e.world.a(this.e.locXAtom.get(), this.e.locYAtom.get() + (double) this.e.getHeadHeight(), this.e.locZAtom.get(), this.f(), this.f(), new Function<EntityHuman, Double>() { // CraftBukkit - fix decompile error
                @Nullable

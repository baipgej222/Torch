...
public class DragonControllerStrafe extends AbstractDragonController {
    ...
    public void c() {
        if (this.f == null) {
            ...
            if (this.d != null && this.d.b()) {
                d0 = this.f.locXAtom.get();
                d1 = this.f.locZAtom.get();
                double d3 = d0 - this.a.locXAtom.get();
                double d4 = d1 - this.a.locZAtom.get();

                d2 = (double) MathHelper.sqrt(d3 * d3 + d4 * d4);
                double d5 = Math.min(0.4000000059604645D + d2 / 80.0D - 1.0D, 10.0D);

                this.e = new Vec3D(d0, this.f.locYAtom.get() + d5, d1);
            }

            d0 = this.e == null ? 0.0D : this.e.c(this.a.locXAtom.get(), this.a.locYAtom.get(), this.a.locZAtom.get());
            ...
            if (this.f.h(this.a) < d1 * d1) {
                if (this.a.hasLineOfSight(this.f)) {
                    ++this.c;
                    Vec3D vec3d = (new Vec3D(this.f.locXAtom.get() - this.a.locXAtom.get(), 0.0D, this.f.locZAtom.get() - this.a.locZAtom.get())).a();
                    ...
                    if (this.c >= 5 && f1 >= 0.0F && f1 < 10.0F) {
                        ...
                        double d6 = this.a.bv.locXAtom.get() - vec3d2.x * d2;
                        double d7 = this.a.bv.locYAtom.get() + (double) (this.a.bv.length / 2.0F) + 0.5D;
                        double d8 = this.a.bv.locZAtom.get() - vec3d2.z * d2;
                        double d9 = this.f.locXAtom.get() - d6;
                        double d10 = this.f.locYAtom.get() + (double) (this.f.length / 2.0F) - (d7 + (double) (this.a.bv.length / 2.0F));
                        double d11 = this.f.locZAtom.get() - d8;
                        ...
                        entitydragonfireball.locXAtom.set(d6);
                        entitydragonfireball.locYAtom.set(d7);
                        entitydragonfireball.locZAtom.set(d8);
    ...
    public void a(EntityLiving entityliving) {
        this.f = entityliving;
        int i = this.a.o();
        int j = this.a.l(this.f.locXAtom.get(), this.f.locYAtom.get(), this.f.locZAtom.get());
        int k = MathHelper.floor(this.f.locXAtom);
        int l = MathHelper.floor(this.f.locZAtom);
        double d0 = (double) k - this.a.locXAtom.get();
        double d1 = (double) l - this.a.locZAtom.get();
        double d2 = (double) MathHelper.sqrt(d0 * d0 + d1 * d1);
        double d3 = Math.min(0.4000000059604645D + d2 / 80.0D - 1.0D, 10.0D);
        int i1 = MathHelper.floor(this.f.locYAtom.get() + d3);

        ...
        if (astring.length < 2) {
            ...
            if (soundcategory == null) {
                ...
                if (d7 > d6) {
                    ...
                    double d8 = d0 - entityplayer.locXAtom.get();
                    double d9 = d1 - entityplayer.locYAtom.get();
                    double d10 = d2 - entityplayer.locZAtom.get();
                    double d11 = Math.sqrt(d8 * d8 + d9 * d9 + d10 * d10);

                    if (d11 > 0.0D) {
                        d0 = entityplayer.locXAtom.get() + d8 / d11 * 2.0D;
                        d1 = entityplayer.locYAtom.get() + d9 / d11 * 2.0D;
                        d2 = entityplayer.locZAtom.get() + d10 / d11 * 2.0D;
                    }

...
public class PathfinderGoalBreed extends PathfinderGoal {
    ...
    private void i() {
        ...
        if (entityageable != null) {
            ...
            entityageable.setPositionRotation(this.animal.locXAtom.get(), this.animal.locYAtom.get(), this.animal.locZAtom.get(), 0.0F, 0.0F);
            ...
            for (int i = 0; i < 7; ++i) {
                ...
                this.a.addParticle(EnumParticle.HEART, this.animal.locXAtom.get() + d3, this.animal.locYAtom.get() + d4, this.animal.locZAtom.get() + d5, d0, d1, d2, new int[0]);
            }

            if (this.a.getGameRules().getBoolean("doMobLoot")) {
                this.a.addEntity(new EntityExperienceOrb(this.a, this.animal.locXAtom.get(), this.animal.locYAtom.get(), this.animal.locZAtom.get(), random.nextInt(7) + 1));
            }

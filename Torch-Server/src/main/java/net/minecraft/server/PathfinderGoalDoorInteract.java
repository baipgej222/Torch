...
public abstract class PathfinderGoalDoorInteract extends PathfinderGoal {
        ...
        if (!this.a.positionChanged) {
            ...
            if (pathentity != null && !pathentity.b() && navigation.f()) {
                for (int i = 0; i < Math.min(pathentity.e() + 2, pathentity.d()); ++i) {
                    ...
                    if (this.a.e((double) this.b.getX(), this.a.locYAtom.get(), (double) this.b.getZ()) <= 2.25D) {
    ...
    public void c() {
        this.d = false;
        this.e = (float) ((double) ((float) this.b.getX() + 0.5F) - this.a.locXAtom.get());
        this.f = (float) ((double) ((float) this.b.getZ() + 0.5F) - this.a.locZAtom.get());
    }

    public void e() {
        float f = (float) ((double) ((float) this.b.getX() + 0.5F) - this.a.locXAtom.get());
        float f1 = (float) ((double) ((float) this.b.getZ() + 0.5F) - this.a.locZAtom.get());

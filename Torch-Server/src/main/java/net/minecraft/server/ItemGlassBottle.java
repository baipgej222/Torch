...
public class ItemGlassBottle extends Item {
    ...
    public InteractionResultWrapper<ItemStack> a(ItemStack itemstack, World world, EntityHuman entityhuman, EnumHand enumhand) {
        ...
        if (!list.isEmpty()) {
            ...
            world.a((EntityHuman) null, entityhuman.locXAtom.get(), entityhuman.locYAtom.get(), entityhuman.locZAtom.get(), SoundEffects.J, SoundCategory.NEUTRAL, 1.0F, 1.0F);
            ...
            if (movingobjectposition == null) {
                ...
                if (movingobjectposition.type == MovingObjectPosition.EnumMovingObjectType.BLOCK) {
                    ...
                    if (world.getType(blockposition).getMaterial() == Material.WATER) {
                        world.a(entityhuman, entityhuman.locXAtom.get(), entityhuman.locYAtom.get(), entityhuman.locZAtom.get(), SoundEffects.I, SoundCategory.NEUTRAL, 1.0F, 1.0F);

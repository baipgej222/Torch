...
public class ItemFishingRod extends Item {
    ...
    public InteractionResultWrapper<ItemStack> a(ItemStack itemstack, World world, EntityHuman entityhuman, EnumHand enumhand) {
        if (entityhuman.hookedFish != null) {
            ...
            // CraftBukkit end
            world.a((EntityHuman) null, entityhuman.locXAtom.get(), entityhuman.locYAtom.get(), entityhuman.locZAtom.get(), SoundEffects.H, SoundCategory.NEUTRAL, 0.5F, 0.4F / (ItemFishingRod.j.nextFloat() * 0.4F + 0.8F));

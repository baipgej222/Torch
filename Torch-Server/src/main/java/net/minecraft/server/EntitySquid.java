...
public class EntitySquid extends EntityWaterAnimal {
    ...
    public void n() {
        ...
        if (this.inWater) {
            ...
            if (!this.world.isClientSide) {
                this.motXAtom.set((double) (this.bC * this.bz));
                this.motYAtom.set((double) (this.bD * this.bz));
                this.motZAtom.set((double) (this.bE * this.bz));
            }

            f = MathHelper.sqrt(this.motXAtom.get() * this.motXAtom.get() + this.motZAtom.get() * this.motZAtom.get());
            this.aN += (-((float) MathHelper.b(this.motXAtom.get(), this.motZAtom.get())) * 57.295776F - this.aN) * 0.1F;
            this.yaw = this.aN;
            this.c = (float) ((double) this.c + 3.141592653589793D * (double) this.bB * 1.5D);
            this.a += (-((float) MathHelper.b((double) f, this.motYAtom.get())) * 57.295776F - this.a) * 0.1F;
        } else {
            ...
            if (!this.world.isClientSide) {
                ...
                if (this.hasEffect(MobEffects.LEVITATION)) {
                    this.motYAtom.set(0.05D * (double) (this.getEffect(MobEffects.LEVITATION).getAmplifier() + 1) - this.motYAtom.get());
                } else {
    ...
    public boolean cG() {
        ...
        return this.locYAtom.get() > world.paperConfig.squidMinSpawnHeight && this.locYAtom.get() < world.paperConfig.squidMaxSpawnHeight && super.cG();
    }

...
public class CommandGive extends CommandAbstract {
    ...
    public void execute(MinecraftServer minecraftserver, ICommandListener icommandlistener, String[] astring) throws CommandException {
        if (astring.length < 2) {
            ...
            if (flag) {
                entityplayer.world.a((EntityHuman) null, entityplayer.locXAtom.get(), entityplayer.locYAtom.get(), entityplayer.locZAtom.get(), SoundEffects.cV, SoundCategory.PLAYERS, 0.2F, ((entityplayer.getRandom().nextFloat() - entityplayer.getRandom().nextFloat()) * 0.7F + 1.0F) * 2.0F);

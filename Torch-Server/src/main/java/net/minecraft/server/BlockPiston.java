...
public class BlockPiston extends BlockDirectional {
    ...
    public static EnumDirection a(BlockPosition blockposition, EntityLiving entityliving) {
        if (MathHelper.e((float) entityliving.locXAtom.get() - (float) blockposition.getX()) < 2.0F && MathHelper.e((float) entityliving.locZAtom.get() - (float) blockposition.getZ()) < 2.0F) {
            double d0 = entityliving.locYAtom.get() + (double) entityliving.getHeadHeight();

            ...
            if (flag) {
                if (this.random.nextBoolean()) {
                    ...
                    for (int l = 0; l < 2; ++l) {
                        ...
                        if (enumparticle == EnumParticle.SPELL_MOB) {
                            ...
                            j = i1 >> 8 & 255;
                            k = i1 & 255;
                            this.world.addParticle(EnumParticle.SPELL_MOB, this.locXAtom.get() + (double) f2, this.locYAtom.get(), this.locZAtom.get() + (double) f3, (double) ((float) i / 255.0F), (double) ((float) j / 255.0F), (double) ((float) k / 255.0F), new int[0]);
                        } else {
                            this.world.addParticle(enumparticle, this.locXAtom.get() + (double) f2, this.locYAtom.get(), this.locZAtom.get() + (double) f3, 0.0D, 0.0D, 0.0D, aint);
                        }
                    }
                }
            } else {
                ...
                for (int j1 = 0; (float) j1 < f5; ++j1) {
                    ...
                    if (enumparticle == EnumParticle.SPELL_MOB) {
                        ...
                        this.world.addParticle(EnumParticle.SPELL_MOB, this.locXAtom.get() + (double) f3, this.locYAtom.get(), this.locZAtom.get() + (double) f6, (double) ((float) j / 255.0F), (double) ((float) k / 255.0F), (double) ((float) k1 / 255.0F), new int[0]);
                    } else {
                        this.world.addParticle(enumparticle, this.locXAtom.get() + (double) f3, this.locYAtom.get(), this.locZAtom.get() + (double) f6, (0.5D - this.random.nextDouble()) * 0.15D, 0.009999999776482582D, (0.5D - this.random.nextDouble()) * 0.15D, aint1);
                    }
                }
            }
        } else {
                    ...
                    if (!list.isEmpty()) {
                        ...
                        while (iterator2.hasNext()) {
                            ...
                            if (!this.g.containsKey(entityliving) && entityliving.cE()) {
                                double d0 = entityliving.locXAtom.get() - this.locXAtom.get();
                                double d1 = entityliving.locZAtom.get() - this.locZAtom.get();

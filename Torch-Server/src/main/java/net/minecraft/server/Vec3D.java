...
public class Vec3D {
    ...
    // Torch start
    public Vec3D(AtomicDouble d0, double d1, AtomicDouble d2) {
        if (d0.get() == -0.0D) {
            d0.set(0.0D);
        }
    ...
    public Vec3D(AtomicDouble d0, AtomicDouble d1, AtomicDouble d2) {
        if (d0.get() == -0.0D) {
            d0.set(0.0D);
        }
    ...
    public double c(AtomicDouble d0, AtomicDouble d1, AtomicDouble d2) {
        double d3 = d0.get() - this.x;
        double d4 = d1.get() - this.y;
        double d5 = d2.get() - this.z;

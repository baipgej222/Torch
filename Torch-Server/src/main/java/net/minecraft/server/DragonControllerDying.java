...
public class DragonControllerDying extends AbstractDragonController {
    ...
    public void b() {
        if (this.c++ % 10 == 0) {
            ...
            this.a.world.addParticle(EnumParticle.EXPLOSION_HUGE, this.a.locXAtom.get() + (double) f, this.a.locYAtom.get() + 2.0D + (double) f1, this.a.locZAtom.get() + (double) f2, 0.0D, 0.0D, 0.0D, new int[0]);
        }
    ...
    public void c() {
        ...
        double d0 = this.b.c(this.a.locXAtom.get(), this.a.locYAtom.get(), this.a.locZAtom.get());

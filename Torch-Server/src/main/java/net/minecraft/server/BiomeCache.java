...
public class BiomeCache {
    ...
    private final Map c = Collections.synchronizedMap(new Long2ObjectOpenHashMap(4096));
    private final List<BiomeCache.a> d = Collections.synchronizedList(Lists.newArrayList());

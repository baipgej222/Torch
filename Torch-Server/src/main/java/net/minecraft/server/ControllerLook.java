...
public class ControllerLook {
    ...
    public void a(Entity entity, float f, float f1) {
        this.e = entity.locXAtom.get();
        if (entity instanceof EntityLiving) {
            this.f = entity.locYAtom.get() + (double) entity.getHeadHeight();
        } else {
            this.f = (entity.getBoundingBox().b + entity.getBoundingBox().e) / 2.0D;
        }

        this.g = entity.locZAtom.get();
        this.b = f;
        this.c = f1;
        this.d = true;
    }
    ...
    public void a() {
        ...
        if (this.d) {
            this.d = false;
            double d0 = this.e - this.a.locXAtom.get();
            double d1 = this.f - (this.a.locYAtom.get() + (double) this.a.getHeadHeight());
            double d2 = this.g - this.a.locZAtom.get();

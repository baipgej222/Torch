    ...
    public void a() {
        ...
        for (int l1 = 0; l1 < list.size(); ++l1) {
            ...
            if (!entity.br()) {
                ...
                if (d7 <= 1.0D) {
                    double d8 = entity.locXAtom.get() - this.posX;
                    double d9 = entity.locYAtom.get() + (double) entity.getHeadHeight() - this.posY;
                    double d10 = entity.locZAtom.get() - this.posZ;
                    ...
                    if (d11 != 0.0D) {
                        ...
                        // CraftBukkit end
                        double d14 = d13; // Torch - fix calculations above being thrown away for non-living entities
                        ...
                        /*
                         entity.motXAtom.set(entity.motXAtom.get() * d8 * d14;
                         entity.motY += d9 * d14;
                         entity.motZ += d10 * d14;
                          */

...
public class PacketPlayOutSpawnEntityLiving implements Packet<PacketListenerPlayOut> {
    ...
    public PacketPlayOutSpawnEntityLiving(EntityLiving entityliving) {
        ...
        this.d = entityliving.locXAtom.get();
        this.e = entityliving.locYAtom.get();
        this.f = entityliving.locZAtom.get();
        ...
        double d0 = 3.9D;
        double d1 = entityliving.motXAtom.get();
        double d2 = entityliving.motYAtom.get();
        double d3 = entityliving.motZAtom.get();

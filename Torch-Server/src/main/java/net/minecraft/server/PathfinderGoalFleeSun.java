...
public class PathfinderGoalFleeSun extends PathfinderGoal {
    ...
    public boolean a() {
        if (!this.f.B()) {
            ...
            return false;
        } else if (!this.f.h(new BlockPosition(this.a.locXAtom.get(), this.a.getBoundingBox().b, this.a.locZAtom.get()))) {
            return false;
    ...
    private Vec3D f() {
        ...
        BlockPosition blockposition = new BlockPosition(this.a.locXAtom.get(), this.a.getBoundingBox().b, this.a.locZAtom.get());

...
public class Navigation extends NavigationAbstract {
    ...
    protected Vec3D c() {
        return new Vec3D(this.a.locXAtom.get(), (double) this.r(), this.a.locZAtom.get());
    }
    ...
    private int r() {
        if (this.a.isInWater() && this.g()) {
            ...
            Block block = this.b.getType(new BlockPosition(MathHelper.floor(this.a.locXAtom), i, MathHelper.floor(this.a.locZAtom))).getBlock();
            int j = 0;
            ...
            do {
                ...
                ++i;
                block = this.b.getType(new BlockPosition(MathHelper.floor(this.a.locXAtom), i, MathHelper.floor(this.a.locZAtom))).getBlock();
                ++j;
            } while (j <= 16);
    ...
    protected void d() {
        ...
        if (this.f) {
            if (this.b.h(new BlockPosition(MathHelper.floor(this.a.locXAtom), (int) (this.a.getBoundingBox().b + 0.5D), MathHelper.floor(this.a.locZAtom)))) {
                return;
            }

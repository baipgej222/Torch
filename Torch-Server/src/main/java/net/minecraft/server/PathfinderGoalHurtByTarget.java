...
public class PathfinderGoalHurtByTarget extends PathfinderGoalTarget {
    ...
    public void c() {
        ...
        if (this.a) {
            double d0 = this.f();
            List list = this.e.world.a(this.e.getClass(), (new AxisAlignedBB(this.e.locXAtom.get(), this.e.locYAtom.get(), this.e.locZAtom.get(), this.e.locXAtom.get() + 1.0D, this.e.locYAtom.get() + 1.0D, this.e.locZAtom.get() + 1.0D)).grow(d0, 10.0D, d0));

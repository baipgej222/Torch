...
public class PortalTravelAgent {
    ...
    public void a(Entity entity, float f) {
        if (this.world.worldProvider.getDimensionManager().getDimensionID() != 1) {
            ...
            int j = MathHelper.floor(entity.locYAtom) - 1;
            int k = MathHelper.floor(entity.locZAtom);
            // CraftBukkit start - Modularize end portal creation
            BlockPosition created = this.createEndPortal(entity.locXAtom.get(), entity.locYAtom.get(), entity.locZAtom.get());
            entity.setPositionRotation((double) created.getX(), (double) created.getY(), (double) created.getZ(), entity.yaw, 0.0F);
            entity.motXAtom.set(0.0D); entity.motYAtom.set(0.0D); entity.motZAtom.set(0.0D);
        }
    }
    ...
    public boolean b(Entity entity, float f) {
        ...
        BlockPosition found = this.findPortal(entity.locXAtom.get(), entity.locYAtom.get(), entity.locZAtom.get(), world.paperConfig.portalSearchRadius); // Paper - Configurable search radius
        if (found == null) {
            return false;
        }
    ...
    public void adjustExit(Entity entity, Location position, Vector velocity) {
        ...
        if (this.world.getWorld().getEnvironment() == org.bukkit.World.Environment.THE_END || entity.getBukkitEntity().getWorld().getEnvironment() == org.bukkit.World.Environment.THE_END || entity.getPortalOffset() == null) {
            ...
            // entity.motXAtom.set(entity.motXAtom.get() * 0.0D;
    ...
    public boolean a(Entity entity) {
        ...
        return this.createPortal(entity.locXAtom.get(), entity.locYAtom.get(), entity.locZAtom.get(), 16);
    }

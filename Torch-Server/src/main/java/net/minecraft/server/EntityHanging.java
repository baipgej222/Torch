...
public abstract class EntityHanging extends Entity {
    ...
    public static AxisAlignedBB calculateBoundingBox(Entity entity, BlockPosition blockPosition, EnumDirection direction, int width, int height) {
        ...
        if (entity != null) {
            entity.locXAtom.set(d0);
            entity.locYAtom.set(d1);
            entity.locZAtom.set(d2);
        }
    ...
    public EntityItem a(ItemStack itemstack, float f) {
        EntityItem entityitem = new EntityItem(this.world, this.locXAtom.get() + (double) ((float) this.direction.getAdjacentX() * 0.15F), this.locYAtom.get() + (double) f, this.locZAtom.get() + (double) ((float) this.direction.getAdjacentZ() * 0.15F), itemstack);

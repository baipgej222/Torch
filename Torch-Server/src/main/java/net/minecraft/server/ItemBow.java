        ...
        if (entityliving instanceof EntityHuman) {
            ...
            if (itemstack1 != null || flag) {
                ...
                if ((double) f >= 0.1D) {
                    ...
                    world.a((EntityHuman) null, entityhuman.locXAtom.get(), entityhuman.locYAtom.get(), entityhuman.locZAtom.get(), SoundEffects.v, SoundCategory.NEUTRAL, 1.0F, 1.0F / (ItemBow.j.nextFloat() * 0.4F + 1.2F) + f * 0.5F);
                    if (!flag1) {
                        --itemstack1.count;

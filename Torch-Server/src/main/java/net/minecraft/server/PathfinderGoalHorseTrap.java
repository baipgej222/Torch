...
public class PathfinderGoalHorseTrap extends PathfinderGoal {
    ...
    public boolean a() {
        return this.a.world.isPlayerNearby(this.a.locXAtom.get(), this.a.locYAtom.get(), this.a.locZAtom.get(), 10.0D);
    }
    ...
    public void e() {
        ...
        this.a.setTame(true);
        this.a.setAgeRaw(0);
        this.a.world.strikeLightning(new EntityLightning(this.a.world, this.a.locXAtom.get(), this.a.locYAtom.get(), this.a.locZAtom.get(), true));
    ...
    private EntityHorse a(DifficultyDamageScaler difficultydamagescaler) {
        ...
        entityhorse.setPosition(this.a.locXAtom.get(), this.a.locYAtom.get(), this.a.locZAtom.get());
    ...
    private EntitySkeleton a(DifficultyDamageScaler difficultydamagescaler, EntityHorse entityhorse) {
        ...
        entityskeleton.setPosition(entityhorse.locXAtom.get(), entityhorse.locYAtom.get(), entityhorse.locZAtom.get());

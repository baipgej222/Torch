...
public class EntitySnowman extends EntityGolem implements IRangedEntity {
    ...
    public void n() {
        ...
        if (!this.world.isClientSide) {
            ...
            int j = MathHelper.floor(this.locYAtom);
            ...
            for (int l = 0; l < 4; ++l) {
                i = MathHelper.floor(this.locXAtom.get() + (double) ((float) (l % 2 * 2 - 1) * 0.25F));
                j = MathHelper.floor(this.locYAtom.get());
                k = MathHelper.floor(this.locZAtom.get() + (double) ((float) (l / 2 % 2 * 2 - 1) * 0.25F));
    ...
    public void a(EntityLiving entityliving, float f) {
        ...
        double d2 = d0 - entitysnowball.locYAtom.get();

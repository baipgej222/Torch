...
public class WorldServer extends World implements IAsyncTaskHandler {
    ...
    protected void i() {
        ...
        if (spigotConfig.randomLightUpdates && !this.players.isEmpty()) { // Spigot
            ...
            int j = MathHelper.floor(entityhuman.locXAtom) + this.random.nextInt(11) - 5;
            int k = MathHelper.floor(entityhuman.locYAtom) + this.random.nextInt(11) - 5;
            int l = MathHelper.floor(entityhuman.locZAtom) + this.random.nextInt(11) - 5;
    ...
    protected void l() {
        ...
        for (int i = 0; i < this.players.size(); ++i) {
            ...
            if (entity.dead) {
                ...
                if (entity.aa.get() && this.isChunkLoaded(j, k, true)) {
    ...
    public boolean strikeLightning(Entity entity) {
        ...
        if (super.strikeLightning(entity)) {
            this.server.getPlayerList().sendPacketNearby((EntityHuman) null, entity.locXAtom.get(), entity.locYAtom.get(), entity.locZAtom.get(), 512.0D, dimension, new PacketPlayOutSpawnEntityWeather(entity)); // CraftBukkit - Use dimension
            return true;
        } else {
            return false;
        }

...
public class EntityArmorStand extends EntityLiving {
    ...
    protected void co() {
        ...
        list.parallelStream().forEach(entityarmorstand -> {
            Entity entity = (Entity) entityarmorstand;
    ...
    private void E() {
        if (this.world instanceof WorldServer) {
            ((WorldServer) this.world).a(EnumParticle.BLOCK_DUST, this.locXAtom.get(), this.locYAtom.get() + (double) this.length / 1.5D, this.locZAtom.get(), 10, (double) (this.width / 4.0F), (double) (this.length / 4.0F), (double) (this.width / 4.0F), 0.05D, new int[] { Block.getCombinedId(Blocks.PLANKS.getBlockData())}); // Torch
        }
    ...
    private void I() {
        this.world.a((EntityHuman) null, this.locXAtom.get(), this.locYAtom.get(), this.locZAtom.get(), SoundEffects.j, this.bA(), 1.0F, 1.0F); // Torch
    ...
    private void a(boolean flag) {
        double d0 = this.locXAtom.get(); // Torch
        double d1 = this.locYAtom.get(); // Torch
        double d2 = this.locZAtom.get(); // Torch

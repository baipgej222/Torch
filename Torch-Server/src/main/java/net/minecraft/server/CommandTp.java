        ...
        if (astring.length < 1) {
            ...
            if (astring.length != 1 && astring.length != 2) {
                if (astring.length < b0 + 3) {
                    ...
                    int i = b0 + 1;
                    CommandAbstract.CommandNumber commandabstract_commandnumber = a(((Entity) object).locXAtom.get(), astring[b0], true);
                    CommandAbstract.CommandNumber commandabstract_commandnumber1 = a(((Entity) object).locYAtom.get(), astring[i++], -512, 512, false);
                    CommandAbstract.CommandNumber commandabstract_commandnumber2 = a(((Entity) object).locZAtom.get(), astring[i++], true);

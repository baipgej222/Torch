...
public class ItemFood extends Item {
    ...
    public ItemStack a(ItemStack itemstack, World world, EntityLiving entityliving) {
        ...
        if (entityliving instanceof EntityHuman) {
            ...
            world.a((EntityHuman) null, entityhuman.locXAtom.get(), entityhuman.locYAtom.get(), entityhuman.locZAtom.get(), SoundEffects.ef, SoundCategory.PLAYERS, 0.5F, world.random.nextFloat() * 0.1F + 0.9F);

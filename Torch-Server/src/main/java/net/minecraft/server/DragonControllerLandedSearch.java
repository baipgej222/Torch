    ...
    public void c() {
        ...
        if (entityhuman != null) {
            if (this.b > 25) {
                ...
                Vec3D vec3d = (new Vec3D(entityhuman.locXAtom.get() - this.a.locXAtom.get(), 0.0D, entityhuman.locZAtom.get() - this.a.locZAtom.get())).a();
                ...
                if (f1 < 0.0F || f1 > 10.0F) {
                    double d0 = entityhuman.locXAtom.get() - this.a.bv.locXAtom.get();
                    double d1 = entityhuman.locZAtom.get() - this.a.bv.locZAtom.get();
            ...
            if (entityhuman != null) {
                ...
                ((DragonControllerCharge) this.a.getDragonControllerManager().b(DragonControllerPhase.i)).a(new Vec3D(entityhuman.locXAtom, entityhuman.locYAtom, entityhuman.locZAtom));
            }
        }

    ...
    public void b(int i, BlockPosition blockposition, int j) {
        ...
        while (iterator.hasNext()) {
            ...
            if (entityplayer != null && entityplayer.world == this.world && entityplayer.getId() != i) {
                double d0 = (double) blockposition.getX() - entityplayer.locXAtom.get();
                double d1 = (double) blockposition.getY() - entityplayer.locYAtom.get();
                double d2 = (double) blockposition.getZ() - entityplayer.locZAtom.get();

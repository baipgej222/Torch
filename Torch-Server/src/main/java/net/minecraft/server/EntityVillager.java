...
public class EntityVillager extends EntityAgeable implements IMerchant, NPC {
        ...
        if (!this.dd() && this.bD > 0) {
            ...
            if (this.bD <= 0) {
                if (this.bE) {
                    ...
                    this.trades.parallelStream().forEach(merchantrecipe -> {
                        if (merchantrecipe.h()) {
                            // CraftBukkit start
    ...
    public void a(MerchantRecipe merchantrecipe) {
        ...
        if (merchantrecipe.j()) {
            this.world.addEntity(new EntityExperienceOrb(this.world, this.locXAtom.get(), this.locYAtom.get() + 0.5D, this.locZAtom.get(), i)); // Torch
        }
    ...
    public void onLightningStrike(EntityLightning entitylightning) {
        if (!this.world.isClientSide && !this.dead) {
            ...
            entitywitch.setPositionRotation(this.locXAtom.get(), this.locYAtom.get(), this.locZAtom.get(), this.yaw, this.pitch); // Torch

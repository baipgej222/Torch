...
public class DefinedStructure {
    ...
    private void a(World world, BlockPosition blockposition, BlockPosition blockposition1) {
        ...
        for (Iterator iterator = list.iterator(); iterator.hasNext(); this.b.add(new DefinedStructure.EntityInfo(vec3d, blockposition2, nbttagcompound, null))) {
            ...
            vec3d = new Vec3D(entity.locXAtom.get() - (double) blockposition.getX(), entity.locYAtom.get() - (double) blockposition.getY(), entity.locZAtom.get() - (double) blockposition.getZ());

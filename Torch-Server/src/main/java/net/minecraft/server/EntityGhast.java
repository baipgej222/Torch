...
public class EntityGhast extends EntityFlying implements IMonster {
        ...
        public void e() {
            ...
            if (entityliving.h(this.ghast) < d0 * d0 && this.ghast.hasLineOfSight(entityliving)) {
                ...
                if (this.a == 20) {
                    ...
                    double d2 = entityliving.locXAtom.get() - (this.ghast.locXAtom.get() + vec3d.x * d1);
                    double d3 = entityliving.getBoundingBox().b + (double) (entityliving.length / 2.0F) - (0.5D + this.ghast.locYAtom.get() + (double) (this.ghast.length / 2.0F));
                    double d4 = entityliving.locZAtom.get() - (this.ghast.locZAtom.get() + vec3d.z * d1);
                    ...
                    entitylargefireball.locXAtom.set(this.ghast.locXAtom.get() + vec3d.x * d1);
                    entitylargefireball.locYAtom.set(this.ghast.locYAtom.get() + (double) (this.ghast.length / 2.0F) + 0.5D);
                    entitylargefireball.locZAtom.set(this.ghast.locZAtom.get() + vec3d.z * d1);
    ...
    static class PathfinderGoalGhastMoveTowardsTarget extends PathfinderGoal {
        ...
        public void e() {
            if (this.a.getGoalTarget() == null) {
                this.a.aN = this.a.yaw = -((float) MathHelper.b(this.a.motXAtom.get(), this.a.motZAtom.get())) * 57.295776F;
            } else {
                EntityLiving entityliving = this.a.getGoalTarget();
                double d0 = 64.0D;

                if (entityliving.h(this.a) < d0 * d0) {
                    double d1 = entityliving.locXAtom.get() - this.a.locXAtom.get();
                    double d2 = entityliving.locZAtom.get() - this.a.locZAtom.get();
    ...
    static class PathfinderGoalGhastIdleMove extends PathfinderGoal {
        ...
        public boolean a() {
            ...
            if (!controllermove.a()) {
                ...
                double d0 = controllermove.d() - this.a.locXAtom.get();
                double d1 = controllermove.e() - this.a.locYAtom.get();
                double d2 = controllermove.f() - this.a.locZAtom.get();
        ...
        public void c() {
            ...
            double d0 = this.a.locXAtom.get() + (double) ((random.nextFloat() * 2.0F - 1.0F) * 16.0F);
            double d1 = this.a.locYAtom.get() + (double) ((random.nextFloat() * 2.0F - 1.0F) * 16.0F);
            double d2 = this.a.locZAtom.get() + (double) ((random.nextFloat() * 2.0F - 1.0F) * 16.0F);
    ...
    static class ControllerGhast extends ControllerMove {
            ...
            if (this.h == ControllerMove.Operation.MOVE_TO) {
                ...
                if (this.j-- <= 0) {
                    ...
                    if (this.b(this.b, this.c, this.d, d3)) {
                        this.i.motXAtom.addAndGet(d0 / d3 * 0.1D);
                        this.i.motYAtom.addAndGet(d1 / d3 * 0.1D);
                        this.i.motZAtom.addAndGet(d2 / d3 * 0.1D);
                    } else {
        ...
        private boolean b(double d0, double d1, double d2, double d3) {
            double d4 = (d0 - this.i.locXAtom.get()) / d3;
            double d5 = (d1 - this.i.locYAtom.get()) / d3;
            double d6 = (d2 - this.i.locZAtom.get()) / d3;

...
public class PathfinderGoalRandomLookaround extends PathfinderGoal {
    ...
    public void e() {
        --this.d;
        this.a.getControllerLook().a(this.a.locXAtom.get() + this.b, this.a.locYAtom.get() + (double) this.a.getHeadHeight(), this.a.locZAtom.get() + this.c, (float) this.a.cF(), (float) this.a.N());
    }
}

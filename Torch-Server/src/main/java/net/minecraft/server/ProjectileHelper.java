...
public final class ProjectileHelper {
    ...
    public static MovingObjectPosition a(Entity entity, boolean flag, boolean flag1, Entity entity1) {
        ...
        double d3 = entity.motXAtom.get();
        double d4 = entity.motYAtom.get();
        double d5 = entity.motZAtom.get();
    ...
    public static final void a(Entity entity, float f) {
        double d0 = entity.motXAtom.get();
        double d1 = entity.motYAtom.get();
        double d2 = entity.motZAtom.get();

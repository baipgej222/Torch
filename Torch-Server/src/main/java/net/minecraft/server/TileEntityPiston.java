            ...
            for (int i = 0; i < list.size(); ++i) {
                ...
                if (entity.z() != EnumPistonReaction.IGNORE) {
                    if (this.a.getBlock() == Blocks.SLIME) {
                        ...
                        case 1:
                            entity.motXAtom.set((double) enumdirection.getAdjacentX());
                            break;

                        case 2:
                            entity.motYAtom.set((double) enumdirection.getAdjacentY());
                            break;

                        case 3:
                            entity.motZAtom.set((double) enumdirection.getAdjacentZ());
                        }
                    }

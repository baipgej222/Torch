...
public class EntityDragonFireball extends EntityFireball {
    ...
    protected void a(MovingObjectPosition movingobjectposition) {
        if (!this.world.isClientSide) {
            ...
            EntityAreaEffectCloud entityareaeffectcloud = new EntityAreaEffectCloud(this.world, this.locXAtom.get(), this.locYAtom.get(), this.locZAtom.get());
            ...
            if (!list.isEmpty()) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (d0 < 16.0D) {
                        entityareaeffectcloud.setPosition(entityliving.locXAtom.get(), entityliving.locYAtom.get(), entityliving.locZAtom.get());
                        break;
                    }
                }
            }

            this.world.triggerEffect(2006, new BlockPosition(this.locXAtom.get(), this.locYAtom.get(), this.locZAtom.get()), 0);

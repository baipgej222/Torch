...
public class DragonControllerLandedFlame extends AbstractDragonControllerLanded {
    ...
    public void c() {
        ...
        if (this.b >= 200) {
            ...
            Vec3D vec3d = (new Vec3D(this.a.bv.locXAtom.get() - this.a.locXAtom.get(), 0.0D, this.a.bv.locZAtom.get() - this.a.locZAtom.get())).a();
            float f = 5.0F;
            double d0 = this.a.bv.locXAtom.get() + vec3d.x * (double) f / 2.0D;
            double d1 = this.a.bv.locZAtom.get() + vec3d.z * (double) f / 2.0D;
            double d2 = this.a.bv.locYAtom.get() + (double) (this.a.bv.length / 2.0F);

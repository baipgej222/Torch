...
public class EntityHorse extends EntityAnimal implements IInventoryListener, IJumpable {
    ...
    private void dI() {
        this.dP();
        if (!this.ad()) {
            this.world.a((EntityHuman) null, this.locXAtom.get(), this.locYAtom.get(), this.locZAtom.get(), SoundEffects.ct, this.bA(), 1.0F, 1.0F + (this.random.nextFloat() - this.random.nextFloat()) * 0.2F);
        }
    ...
    public void e(float f, float f1) {
        ...
        if (i > 0) {
            ...
            IBlockData iblockdata = this.world.getType(new BlockPosition(this.locXAtom.get(), this.locYAtom.get() - 0.2D - (double) this.lastYaw, this.locZAtom.get()));
            Block block = iblockdata.getBlock();

            if (iblockdata.getMaterial() != Material.AIR && !this.ad()) {
                SoundEffectType soundeffecttype = block.w();

                this.world.a((EntityHuman) null, this.locXAtom.get(), this.locYAtom.get(), this.locZAtom.get(), soundeffecttype.d(), this.bA(), soundeffecttype.a() * 0.5F, soundeffecttype.b() * 0.75F);
            }
    ...
    protected EntityHorse a(Entity entity, double d0) {
        ...
        while (iterator.hasNext()) {
            ...
            double d2 = entity2.e(entity.locXAtom.get(), entity.locYAtom.get(), entity.locZAtom.get());
    ...
    public void n() {
        ...
        if (!this.world.isClientSide) {
            ...
            if (!this.dn() && !this.isVehicle() && this.random.nextInt(300) == 0 && this.world.getType(new BlockPosition(MathHelper.floor(this.locXAtom), MathHelper.floor(this.locYAtom) - 1, MathHelper.floor(this.locZAtom))).getBlock() == Blocks.GRASS) {
                this.u(true);
            }
    ...
    public void g(float f, float f1) {
        if (this.isVehicle() && this.cL() && this.dv()) {
            ...
            if (this.jumpPower > 0.0F && !this.dk() && this.onGround) {
                this.motYAtom.set(this.getJumpStrength() * (double) this.jumpPower);
                ...
                if (f1 > 0.0F) {
                    ...
                    this.motXAtom.addAndGet((double) (-0.4F * f2 * this.jumpPower));
                    this.motZAtom.addAndGet((double) (0.4F * f3 * this.jumpPower));
    ...
    public void k(Entity entity) {
        ...
        if (this.ca > 0.0F) {
            ...
            entity.setPosition(this.locXAtom.get() + (double) (f2 * f), this.locYAtom.get() + this.ay() + entity.ax() + (double) f3, this.locZAtom.get() - (double) (f2 * f1));

...
public class ItemBoat extends Item {
    ...
    public InteractionResultWrapper<ItemStack> a(ItemStack itemstack, World world, EntityHuman entityhuman, EnumHand enumhand) {
        ...
        double d0 = entityhuman.lastXAtom.get() + (entityhuman.locXAtom.get() - entityhuman.lastXAtom.get()) * (double) f;
        double d1 = entityhuman.lastYAtom.get() + (entityhuman.locYAtom.get() - entityhuman.lastYAtom.get()) * (double) f + (double) entityhuman.getHeadHeight();
        double d2 = entityhuman.lastZAtom.get() + (entityhuman.locZAtom.get() - entityhuman.lastZAtom.get()) * (double) f;

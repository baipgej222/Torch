...
public abstract class EntityHuman extends EntityLiving {
    ...
    public EntityHuman(World world, GameProfile gameprofile) {
        ...
        this.ba = 180.0F;
        this.maxFireTicks.set(20); // Torch
    }
    ...
    public void m() {
        ...
        int i = 29999999;
        double d0 = MathHelper.a(this.locXAtom.get(), -2.9999999E7D, 2.9999999E7D);
        double d1 = MathHelper.a(this.locZAtom.get(), -2.9999999E7D, 2.9999999E7D);

        if (d0 != this.locXAtom.get() || d1 != this.locZAtom.get()) {
            this.setPosition(d0, this.locYAtom.get(), d1);
        }
    ...
    private void o() {
        ...
        this.bB = this.bE;
        this.bC = this.bF;
        double d0 = this.locXAtom.get() - this.bD;
        double d1 = this.locYAtom.get() - this.bE;
        double d2 = this.locZAtom.get() - this.bF;
        double d3 = 10.0D;

        if (d0 > d3) {
            this.bA = this.bD = this.locXAtom.get();
        }

        if (d2 > d3) {
            this.bC = this.bF = this.locZAtom.get();
        }

        if (d1 > d3) {
            this.bB = this.bE = this.locYAtom.get();
        }
    ...
    public void a(SoundEffect soundeffect, float f, float f1) {
        this.world.a(this, this.locXAtom.get(), this.locYAtom.get(), this.locZAtom.get(), soundeffect, this.bA(), f, f1);
    }
    ...
    public void aw() {
        if (!this.world.isClientSide && this.isSneaking() && this.isPassenger()) {
            ...
            double d0 = this.locXAtom.get();
            double d1 = this.locYAtom.get();
            double d2 = this.locZAtom.get();
            float f = this.yaw;
            float f1 = this.pitch;
            ...
            this.bx = this.by;
            this.by = 0.0F;
            this.m(this.locXAtom.get() - d0, this.locYAtom.get() - d1, this.locZAtom.get() - d2);
    ...
    public void n() {
        ...
        float f1 = (float) ( org.bukkit.craftbukkit.TrigMath.atan(-this.motYAtom.get() * 0.20000000298023224D) * 15.0D); // CraftBukkit
        ...
        if (this.getHealth() > 0.0F && !this.isSpectator()) {
            ...
            list.parallelStream().forEach(entityhuman -> {
            	Entity entity = (Entity) entityhuman;
    ...
    public void die(DamageSource damagesource) {
        ...
        this.motYAtom.set(0.10000000149011612D);
        ...
        if (damagesource != null) {
            this.motXAtom.set((double) (-MathHelper.cos((this.aA + this.yaw) * 0.017453292F) * 0.1F));
            this.motZAtom.set((double) (-MathHelper.sin((this.aA + this.yaw) * 0.017453292F) * 0.1F));
        } else {
            this.motXAtom.set(0.0D); this.motZAtom.set(0.0D);
        }
    ...
    public EntityItem a(@Nullable ItemStack itemstack, boolean flag, boolean flag1) {
        if (itemstack == null) {
            ...
            double d0 = this.locYAtom.get() - 0.30000001192092896D + (double) this.getHeadHeight();
            EntityItem entityitem = new EntityItem(this.world, this.locXAtom.get(), d0, this.locZAtom.get(), itemstack);
            ...
            if (flag) {
                ...
                entityitem.motXAtom.set((double) (-MathHelper.sin(f1) * f));
                entityitem.motZAtom.set((double) (MathHelper.cos(f1) * f));
                entityitem.motYAtom.set(0.20000000298023224D);
            } else {
                f = 0.3F;
                entityitem.motXAtom.set((double) (-MathHelper.sin(this.yaw * 0.017453292F) * MathHelper.cos(this.pitch * 0.017453292F) * f));
                entityitem.motZAtom.set((double) (MathHelper.cos(this.yaw * 0.017453292F) * MathHelper.cos(this.pitch * 0.017453292F) * f));
                entityitem.motYAtom.set((double) (-MathHelper.sin(this.pitch * 0.017453292F) * f + 0.1F));
                f1 = this.random.nextFloat() * 6.2831855F;
                f = 0.02F * this.random.nextFloat();
                entityitem.motXAtom.addAndGet((Math.cos((double) f1) * (double) f));
                entityitem.motYAtom.addAndGet((double) ((this.random.nextFloat() - this.random.nextFloat()) * 0.1F));
                entityitem.motZAtom.addAndGet(Math.sin((double) f1) * (double) f);
            }
            ...
            if (!entity.t(this)) {
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (this.isSprinting() && flag) {
                        this.world.a((EntityHuman) null, this.locXAtom.get(), this.locYAtom.get(), this.locZAtom.get(), SoundEffects.dY, this.bA(), 1.0F, 1.0F);
                        ++i;
                        flag1 = true;
                    }
                    ...
                    double d1 = entity.motXAtom.get();
                    double d2 = entity.motYAtom.get();
                    double d3 = entity.motZAtom.get();
                    ...
                    if (flag5) {
                        if (i > 0) {
                            ...
                            this.motXAtom.set(this.motXAtom.get() * 0.6D);
                            this.motZAtom.set(this.motXAtom.get() * 0.6D);
                        ...
                        if (flag3) {
                            ...
                            this.world.a((EntityHuman) null, this.locXAtom.get(), this.locYAtom.get(), this.locZAtom.get(), SoundEffects.eb, this.bA(), 1.0F, 1.0F);
                            this.cI();
                        }
                        ...
                        if (entity instanceof EntityPlayer && entity.velocityChanged) {
                            ...
                            entity.motXAtom.set(d1);
                            entity.motYAtom.set(d2);
                            entity.motZAtom.set(d3);
                            }
                            // CraftBukkit end
                        }

                        if (flag2) {
                            this.world.a((EntityHuman) null, this.locXAtom.get(), this.locYAtom.get(), this.locZAtom.get(), SoundEffects.ENTITY_PLAYER_ATTACK_CRIT, this.bA(), 1.0F, 1.0F);
                            this.a(entity);
                        }

                        if (!flag2 && !flag3) {
                            if (flag) {
                                this.world.a((EntityHuman) null, this.locXAtom.get(), this.locYAtom.get(), this.locZAtom.get(), SoundEffects.ea, this.bA(), 1.0F, 1.0F);
                            } else {
                                this.world.a((EntityHuman) null, this.locXAtom.get(), this.locYAtom.get(), this.locZAtom.get(), SoundEffects.ec, this.bA(), 1.0F, 1.0F);
                            }
                        }
                        ...
                        if (entity instanceof EntityLiving) {
                            ...
                            if (this.world instanceof WorldServer && f5 > 2.0F) {
                                ...
                                ((WorldServer) this.world).a(EnumParticle.DAMAGE_INDICATOR, entity.locXAtom.get(), entity.locYAtom.get() + (double) (entity.length * 0.5F), entity.locZAtom.get(), k, 0.1D, 0.0D, 0.1D, 0.2D, new int[0]);
                            }
                        }

                        this.applyExhaustion(world.spigotConfig.combatExhaustion); // Spigot - Change to use configurable value
                    } else {
                        this.world.a((EntityHuman) null, this.locXAtom.get(), this.locYAtom.get(), this.locZAtom.get(), SoundEffects.dZ, this.bA(), 1.0F, 1.0F);
                        if (flag4) {
                            entity.extinguish();
                        }
                    }
    ...
    public void cI() {
        ...
        if (this.world instanceof WorldServer) {
            ((WorldServer) this.world).a(EnumParticle.SWEEP_ATTACK, this.locXAtom.get() + d0, this.locYAtom.get() + (double) this.length * 0.5D, this.locZAtom.get() + d1, 0, d0, 0.0D, d1, 0.0D, new int[0]);
        }
    ...
    public EntityHuman.EnumBedResult a(BlockPosition blockposition) {
        if (!this.world.isClientSide) {
            ...
            if (Math.abs(this.locXAtom.get() - (double) blockposition.getX()) > 3.0D || Math.abs(this.locYAtom.get() - (double) blockposition.getY()) > 2.0D || Math.abs(this.locZAtom.get() - (double) blockposition.getZ()) > 3.0D) {
        ...
        this.motXAtom.set(0.0D); this.motZAtom.set(0.0D); this.motYAtom.set(0.0D);
        if (!this.world.isClientSide) {
    ...
    public void g(float f, float f1) {
        ...
        if (this.abilities.isFlying && !this.isPassenger()) {
            double d3 = this.motYAtom.get();
            float f2 = this.aR;

            this.aR = this.abilities.a() * (float) (this.isSprinting() ? 2 : 1);
            super.g(f, f1);
            this.motYAtom.set(d3 * 0.6D);
            this.aR = f2;
        ...
        this.checkMovement(this.locXAtom.get() - d0, this.locYAtom.get() - d1, this.locZAtom.get() - d2);
    }
        ...
        if (this.isPassenger()) {
            ...
            if (i > 0) {
                if (this.bz() instanceof EntityMinecartAbstract) {
                    ...
                    } else if (this.g.distanceSquared((double) MathHelper.floor(this.locXAtom), (double) MathHelper.floor(this.locYAtom), (double) MathHelper.floor(this.locZAtom)) >= 1000000.0D) {
    ...
    public void levelDown(int i) {
        ...
        if (i > 0 && this.expLevel % 5 == 0 && (float) this.bR < (float) this.ticksLived - 100.0F) {
            ...
            this.world.a((EntityHuman) null, this.locXAtom.get(), this.locYAtom.get(), this.locZAtom.get(), SoundEffects.ei, this.bA(), f * 0.75F, 1.0F);

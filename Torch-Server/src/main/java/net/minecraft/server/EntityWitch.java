...
public class EntityWitch extends EntityMonster implements IRangedEntity {
        ...
        if (!this.world.isClientSide) {
            if (this.o()) {
                ...
                if (potionregistry != null) {
                    ...
                    this.a(true);
                    this.world.a((EntityHuman) null, this.locXAtom.get(), this.locYAtom.get(), this.locZAtom.get(), SoundEffects.gC, this.bA(), 1.0F, 0.8F + this.random.nextFloat() * 0.4F);
    ...
    public void a(EntityLiving entityliving, float f) {
        if (!this.o()) {
            double d0 = entityliving.locYAtom.get() + (double) entityliving.getHeadHeight() - 1.100000023841858D;
            double d1 = entityliving.locXAtom.get() + entityliving.motXAtom.get() - this.locXAtom.get();
            double d2 = d0 - this.locYAtom.get();
            double d3 = entityliving.locZAtom.get() + entityliving.motZAtom.get() - this.locZAtom.get();
            ...
            this.world.a((EntityHuman) null, this.locXAtom.get(), this.locYAtom.get(), this.locZAtom.get(), SoundEffects.gE, this.bA(), 1.0F, 0.8F + this.random.nextFloat() * 0.4F);

...
public class PacketPlayOutSpawnEntity implements Packet<PacketListenerPlayOut> {
    ...
    public PacketPlayOutSpawnEntity(Entity entity, int i, int j) {
        ...
        this.c = entity.locXAtom.get();
        this.d = entity.locYAtom.get();
        this.e = entity.locZAtom.get();
        ...
        this.f = (int) (MathHelper.a(entity.motXAtom.get(), -3.9D, 3.9D) * 8000.0D);
        this.g = (int) (MathHelper.a(entity.motYAtom.get(), -3.9D, 3.9D) * 8000.0D);
        this.h = (int) (MathHelper.a(entity.motZAtom.get(), -3.9D, 3.9D) * 8000.0D);
    }

...
public class EntityShulker extends EntityGolem implements IMonster {
    ...
    public void m() {
        ...
        if (blockposition != null) {
            ...
            double x = (double) blockposition.getX() + 0.5D; this.M = x; this.lastXAtom.set(x); this.locXAtom.set(x);
            double y = (double) blockposition.getY(); this.N = y; this.lastYAtom.set(y); this.locYAtom.set(y);
            double z = (double) blockposition.getZ() + 0.5D; this.O = z; this.lastZAtom.set(z); this.locZAtom.set(z);
            ...
            case 1:
            default:
                this.a(new AxisAlignedBB(this.locXAtom.get() - 0.5D, this.locYAtom.get(), this.locZAtom.get() - 0.5D, this.locXAtom.get() + 0.5D, this.locYAtom.get() + 1.0D + d0, this.locZAtom.get() + 0.5D));
                d4 = d2;
                break;

            case 2:
                this.a(new AxisAlignedBB(this.locXAtom.get() - 0.5D, this.locYAtom.get() - d0, this.locZAtom.get() - 0.5D, this.locXAtom.get() + 0.5D, this.locYAtom.get() + 1.0D, this.locZAtom.get() + 0.5D));
                d4 = -d2;
                break;

            case 3:
                this.a(new AxisAlignedBB(this.locXAtom.get() - 0.5D, this.locYAtom.get(), this.locZAtom.get() - 0.5D, this.locXAtom.get() + 0.5D, this.locYAtom.get() + 1.0D, this.locZAtom.get() + 0.5D + d0));
                d5 = d2;
                break;

            case 4:
                this.a(new AxisAlignedBB(this.locXAtom.get() - 0.5D, this.locYAtom.get(), this.locZAtom.get() - 0.5D - d0, this.locXAtom.get() + 0.5D, this.locYAtom.get() + 1.0D, this.locZAtom.get() + 0.5D));
                d5 = -d2;
                break;

            case 5:
                this.a(new AxisAlignedBB(this.locXAtom.get() - 0.5D, this.locYAtom.get(), this.locZAtom.get() - 0.5D, this.locXAtom.get() + 0.5D + d0, this.locYAtom.get() + 1.0D, this.locZAtom.get() + 0.5D));
                d3 = d2;
                break;

            case 6:
                this.a(new AxisAlignedBB(this.locXAtom.get() - 0.5D - d0, this.locYAtom.get(), this.locZAtom.get() - 0.5D, this.locXAtom.get() + 0.5D, this.locYAtom.get() + 1.0D, this.locZAtom.get() + 0.5D));
                d3 = -d2;
            }

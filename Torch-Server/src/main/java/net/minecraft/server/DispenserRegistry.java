    ...
    static void b() {
        ...
        BlockDispenser.REGISTRY.a(Item.getItemOf(Blocks.TNT), new DispenseBehaviorItem() {
            protected ItemStack b(ISourceBlock isourceblock, ItemStack itemstack) {
                ...
                world.a((EntityHuman) null, entitytntprimed.locXAtom.get(), entitytntprimed.locYAtom.get(), entitytntprimed.locZAtom.get(), SoundEffects.gk, SoundCategory.BLOCKS, 1.0F, 1.0F);

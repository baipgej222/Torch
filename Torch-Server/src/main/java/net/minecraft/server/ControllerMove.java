    ...
    public void c() {
        ...
        if (this.h == ControllerMove.Operation.STRAFE) {
            ...
            if (navigationabstract != null) {
                ...
                if (pathfinderabstract != null && pathfinderabstract.a(this.a.world, MathHelper.floor(this.a.locXAtom.get() + (double) f8), MathHelper.floor(this.a.locYAtom.get()), MathHelper.floor(this.a.locZAtom.get() + (double) f)) != PathType.WALKABLE) {
                    this.f = 1.0F;
                    this.g = 0.0F;
                    f2 = f1;
                }
            ...
            this.h = ControllerMove.Operation.WAIT;
            double d0 = this.b - this.a.locXAtom.get();
            double d1 = this.d - this.a.locZAtom.get();
            double d2 = this.c - this.a.locYAtom.get();

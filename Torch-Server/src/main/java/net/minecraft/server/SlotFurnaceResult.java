    ...
    protected void c(ItemStack itemstack) {
        ...
        if (!this.a.world.isClientSide) {
            ...
            if (f == 0.0F) {
                ...
                if (j < MathHelper.f((float) i * f) && ThreadLocalRandom.current().nextDouble() < (double) ((float) i * f - (float) j)) { // Torch
                    ++j;
                }
            ...
            while (i > 0) {
                ...
                i -= j;
                this.a.world.addEntity(new EntityExperienceOrb(this.a.world, this.a.locXAtom.get(), this.a.locYAtom.get() + 0.5D, this.a.locZAtom.get() + 0.5D, j));
            }
        }

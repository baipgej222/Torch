...
public class CommandExecute extends CommandAbstract {
    ...
    public void execute(final MinecraftServer minecraftserver, final ICommandListener icommandlistener, String[] astring) throws CommandException {
        if (astring.length < 5) {
            ...
            final double d0 = b(entity.locXAtom.get(), astring[1], false);
            final double d1 = b(entity.locYAtom.get(), astring[2], false);
            final double d2 = b(entity.locZAtom.get(), astring[3], false);

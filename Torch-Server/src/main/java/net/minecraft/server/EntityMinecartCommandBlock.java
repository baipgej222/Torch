...
public class EntityMinecartCommandBlock extends EntityMinecartAbstract {
    ...
    private final CommandBlockListenerAbstract c = new CommandBlockListenerAbstract() {
        ...
        public BlockPosition getChunkCoordinates() {
            return new BlockPosition(EntityMinecartCommandBlock.this.locXAtom.get(), EntityMinecartCommandBlock.this.locYAtom.get() + 0.5D, EntityMinecartCommandBlock.this.locZAtom.get());
        }

        public Vec3D d() {
            return new Vec3D(EntityMinecartCommandBlock.this.locXAtom.get(), EntityMinecartCommandBlock.this.locYAtom.get(), EntityMinecartCommandBlock.this.locZAtom.get());
        }

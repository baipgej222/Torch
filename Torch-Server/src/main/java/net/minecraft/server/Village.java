...
public class Village {
    ...
    private World a;
    private final List<VillageDoor> b = Collections.synchronizedList(Lists.newArrayList());
    ...
    private void n() {
        ...
        if (i == 0) {
            ...
            // Torch start - synchronized iterator
            // synchronized(this.b) {

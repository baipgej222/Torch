    ...
    protected void a(MovingObjectPosition movingobjectposition) {
        if (!this.world.isClientSide) {
            ...
            if (!event.isCancelled()) {
                this.world.createExplosion(this, this.locXAtom.get(), this.locYAtom.get(), this.locZAtom.get(), event.getRadius(), event.getFire(), this.world.getGameRules().getBoolean("mobGriefing")); // Torch
            }
            // CraftBukkit end
            this.die();
        }

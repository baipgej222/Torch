...
public class EntityPig extends EntityAnimal {
    ...
    public void onLightningStrike(EntityLightning entitylightning) {
        if (!this.world.isClientSide && !this.dead) {
            ...
            entitypigzombie.setPositionRotation(this.locXAtom.get(), this.locYAtom.get(), this.locZAtom.get(), this.yaw, this.pitch);
    ...
    public void e(float f, float f1) {
        ...
        if (f > 5.0F) {
            ...
            this.b(EntityHuman.class).parallelStream().forEach(entityhuman -> {

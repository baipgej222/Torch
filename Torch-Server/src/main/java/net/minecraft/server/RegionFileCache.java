...
public class RegionFileCache {
    ...
    public static final Map<File, RegionFile> a = new ConcurrentLinkedHashMap.Builder<File, RegionFile>().maximumWeightedCapacity(PaperConfig.regionFileCacheSize).initialCapacity(PaperConfig.regionFileCacheSize).build(); // Spigot - private -> public, Paper - HashMap -> LinkedHashMap // Torch
    ...
    public static synchronized void a() {
        ...
        RegionFileCache.a.values().stream().forEach(regionfile -> {
            try {
                if (regionfile != null) {
                    regionfile.c();
                }

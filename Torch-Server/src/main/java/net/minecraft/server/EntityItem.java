...
// TacoSpigot end
    ...
    public EntityItem(World world, double d0, double d1, double d2) {
        ...
        this.motXAtom.set((double) ((float) (Math.random() * 0.20000000298023224D - 0.10000000149011612D)));
        this.motYAtom.set(0.20000000298023224D);
        this.motZAtom.set((double) ((float) (Math.random() * 0.20000000298023224D - 0.10000000149011612D)));
    }
    ...
    public void m() {
        if (this.getItemStack() == null) {
            ...
            this.noclip = this.j(this.locXAtom.get(), (this.getBoundingBox().b + this.getBoundingBox().e) / 2.0D, this.locZAtom.get());
            this.move(this.motXAtom.get(), this.motYAtom.get(), this.motZAtom.get());
            boolean flag = (int) this.lastXAtom.get() != (int) this.locXAtom.get() || (int) this.lastYAtom.get() != (int) this.locYAtom.get() || (int) this.lastZAtom.get() != (int) this.locZAtom.get();
    ...
    public void d(EntityHuman entityhuman) {
        if (!this.world.isClientSide) {
            ...
            if (this.pickupDelay == 0 && (this.h == null || 6000 - this.age <= 200 || this.h.equals(entityhuman.getName())) && entityhuman.inventory.pickup(itemstack)) {
                ...
                if (!this.ad()) {
                    this.world.a((EntityHuman) null, entityhuman.locXAtom.get(), entityhuman.locYAtom.get(), entityhuman.locZAtom.get(), SoundEffects.cV, SoundCategory.PLAYERS, 0.2F, ((this.random.nextFloat() - this.random.nextFloat()) * 0.7F + 1.0F) * 2.0F);
                }

...
public class InventoryUtils {
    ...
    public static void dropEntity(World world, Entity entity, IInventory iinventory) {
        dropInventory(world, entity.locXAtom.get(), entity.locYAtom.get(), entity.locZAtom.get(), iinventory);
    }
    ...
    public static void dropItem(World world, double d0, double d1, double d2, ItemStack itemstack) {
        ...
        while (itemstack.count > 0) {
            ...
            entityitem.motXAtom.set(InventoryUtils.a.nextGaussian() * (double) f3);
            entityitem.motYAtom.set(InventoryUtils.a.nextGaussian() * (double) f3 + 0.20000000298023224D);
            entityitem.motZAtom.set(InventoryUtils.a.nextGaussian() * (double) f3);

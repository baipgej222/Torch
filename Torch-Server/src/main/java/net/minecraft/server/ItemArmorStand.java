                ...
                if (flag1) {
                    ...
                    if (!list.isEmpty()) {
                        ...
                        if (!world.isClientSide) {
                            ...
                            world.a((EntityHuman) null, entityarmorstand.locXAtom.get(), entityarmorstand.locYAtom.get(), entityarmorstand.locZAtom.get(), SoundEffects.m, SoundCategory.BLOCKS, 0.75F, 0.8F);
                        }

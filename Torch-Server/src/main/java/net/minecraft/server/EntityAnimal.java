    ...
    public void n() {
        ...
        if (this.bw > 0) {
            ...
            if (this.bw % 10 == 0) {
                ...
                this.world.addParticle(EnumParticle.HEART, this.locXAtom.get() + (double) (this.random.nextFloat() * this.width * 2.0F) - (double) this.width, this.locYAtom.get() + 0.5D + (double) (this.random.nextFloat() * this.length), this.locZAtom.get() + (double) (this.random.nextFloat() * this.width * 2.0F) - (double) this.width, d0, d1, d2, new int[0]);
            }
        }
